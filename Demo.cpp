...
cout << "Shortest path from 0 to 2: " << Algorithms::shortestPath(g, 0, 2) << endl; /// Should print: "-1" (no path).
cout << "Contains cycle? " << Algorithms::isContainsCycle(g) << endl;    // Should print: "Cycle detected!".
cout << "Is bipartite? " << Algorithms::isBipartite(g) << endl;        /// Should print: "0" (false).
cout << "Has negative cycle from 0? " << Algorithms::negativeCycle(g,0) << endl;   // Should print: "1" (true).
}
